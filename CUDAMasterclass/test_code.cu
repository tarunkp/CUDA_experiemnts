...
//}
//
//// reduction warp unrolling
//__global__ void reduction_kernel_interleaved_warp_unrolling_1(int * int_array,
//	int * temp_array, int size)
//{
//	int tid = threadIdx.x;
//
...
//	int * i_data = int_array + blockDim.x * blockIdx.x;
//
//	for (int offset = blockDim.x / 2; offset > 32;
//		offset = offset / 2)
//	{
//		if (tid < offset)
//		{
...
//	//{
//	//case 1024:
//	//	reduction_kernel_complete_template_1 <1024> << < grid, block >> > (d_input, d_temp, size);
//	//	break;
//	//case 512:
//	//	reduction_kernel_complete_template_1 <512> << < grid, block >> > (d_input, d_temp, size);
//	//	break;
//	//case 256:
//	//	reduction_kernel_complete_template_1 <256> << < grid, block >> > (d_input, d_temp, size);
//	//	break;
//	//case 128:
//	//	reduction_kernel_complete_template_1 <128> << < grid, block >> > (d_input, d_temp, size);
//	//	break;
//	//case 64:
//	//	reduction_kernel_complete_template_1 <64> << < grid, block >> > (d_input, d_temp, size);
//	//	break;
//	//}
//
